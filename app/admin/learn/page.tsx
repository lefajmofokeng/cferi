...
export default async function AdminLearnPage() {
  ...
  if (error) {
    return (
      <main className="p-6">
        <div className="bg-red-50 border border-red-200 rounded-[12px] p-4 text-sm text-red-600 flex items-center gap-2">
        ...
        {articles.length === 0 ? (
          <div className="py-16 text-center">
            ...
            <p className="text-xs text-gray-400 mt-1">
              Get started by creating a new learning article above.
            </p>
          </div>
        ) : (
